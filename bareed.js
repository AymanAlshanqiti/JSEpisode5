...
class Vendor extends Person {
  ...
  // ** If we don't write a constructor the default constructore that going to work is a supper class constructer ** //
...
class Customer extends Person {
  ...
  _isInRange = vendor =>
    // It's return true if it's true and false if it's false
